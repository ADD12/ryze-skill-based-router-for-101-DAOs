...
Also update the repository description and rename the repository:
- Current repo: ADD12/ryze-skill-based-router-for-101-DAOs
- New repo name: rye-skill-based-router-for-101-DAOs
- New description: "Rye is a skill-based routing AI agent for your next company or DAO"
